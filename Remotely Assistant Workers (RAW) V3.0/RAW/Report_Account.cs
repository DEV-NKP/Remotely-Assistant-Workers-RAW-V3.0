...
namespace RAW
{
    public partial class Report_Account : Form
    {
        ...
        private void TextBoxReportAccName_TextChanged(object sender, EventArgs e)
        {
            if (string.IsNullOrEmpty(TextBoxReportAccName.Text))
            {
                nm = false;
                EnableButton();
            }
        ...
        private void TextboxReportAccEmail_TextChanged(object sender, EventArgs e)
        {
            if (string.IsNullOrEmpty(TextboxReportAccEmail.Text))
            {
                em = false;
                EnableButton();
            }
        ...
        private void TextboxReportAccProblem_TextChanged(object sender, EventArgs e)
        {
            if (string.IsNullOrEmpty(TextboxReportAccProblem.Text))
            {
                sprb = false;
                EnableButton();
            }
        ...
        private void TextboxReportAccComment_TextChanged(object sender, EventArgs e)
        {
        ...
        private void ButtonReportAccReset_Click(object sender, EventArgs e)
        {
            ...
            TextboxReportAccComment.Text = "";
            TextBoxReportAccName.Text = "";
            TextboxReportAccEmail.Text = "";
            TextboxReportAccProblem.Text = "";
        ...
        private void ButtonReportAccSubmit_Click(object sender, EventArgs e)
        {
            ...
            FULL_NAME = TextBoxReportAccName.Text;
            EMAIL = TextboxReportAccEmail.Text;

            REPORT_SECTION = "ACCOUNT";
            SUB_PROBLEM_TYPE = TextboxReportAccProblem.Text;

            SUSPECT_NAME = "N/A";
            BANK_ACCOUNT_NO = "N/A";

            ADDITIONAL_COMMENT = TextboxReportAccComment.Text;
